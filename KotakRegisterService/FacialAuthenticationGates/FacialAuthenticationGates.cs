...
namespace KMBL.StepupAuthentication.CoreComponents
{
    ...
    public class ExecutingSP
    {
        ...
        public string InsertUserSurveyData(string CRN, int customer_registration_checker_id, int rate_experience, string suggestion_text)
        {
            string get_user_survey_id = "";
            var dbManager = new DBManager("DBConnection");
            ...
            get_user_survey_id = objCmd.Parameters["v_user_survey_id"].Value.ToString();
