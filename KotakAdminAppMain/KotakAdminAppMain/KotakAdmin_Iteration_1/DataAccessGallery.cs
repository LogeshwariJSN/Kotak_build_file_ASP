    ...
    public class DataAccessGallery
    {
        ...
        public static List<DataMigrationData> GetDataMigrationData()
        {
            ...
            while (dataReader.Read())
            {
                ...
                {
                    customer_registration_checker_id = dataReader.IsDBNull(0) ? 0 : dataReader.GetInt32(0),
                    CRN = dataReader.IsDBNull(1) ? null : dataReader.GetString(1),
                    created_on = dataReader.IsDBNull(2) ? null : dataReader.GetString(2),
                    trained_resource_group_id = dataReader.IsDBNull(3) ? null : dataReader.GetString(3),
                });
            }
            dataReader.Close();
            dbManager.CloseConnection(connection);
