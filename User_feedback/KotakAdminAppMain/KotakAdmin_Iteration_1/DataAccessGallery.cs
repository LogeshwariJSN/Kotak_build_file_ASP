...
namespace KotakAdmin_Iteration_1
{
    ...
    public class DataMigrationData
    {
        ...
        public string trained_resource_group_id { get; set; }
    ...
    public class UserFeedbackData
    {
        ...
        public string user_answer1 { get; set; }
        public string user_answer2 { get; set; }
        public string suggestion { get; set; }
        public string created_on { get; set; }
    }

    public class MasterUserAnswerFetch
    {
    ...
    public class DataAccessGallery
    {
        ...
        public static List<DataMigrationData> GetDataMigrationData()
        {
            ...
            while (dataReader.Read())
            {
                ...
                DataMigrationData dmdi = new DataMigrationData();
                dmdi.customer_registration_checker_id = dataReader.IsDBNull(0) ? 0 : dataReader.GetInt32(0);
                dmdi.CRN = dataReader.IsDBNull(1) ? null : dataReader.GetString(1);
                dmdi.created_on = dataReader.IsDBNull(2) ? null : dataReader.GetString(2);
                dmdi.trained_resource_group_id = dataReader.IsDBNull(3) ? null : dataReader.GetString(3);
                dmd.Add(dmdi);
            }
            dataReader.Close();
            dbManager.CloseConnection(connection);
        ...
        public static GetCustomerImageData GetCustomerImageData(int customer_registration_checker_id)
        {
            ...
            while (dataReader.Read())
            {
                ...
                gcid.customer_image_id = dataReader.IsDBNull(2) ? null : dataReader.GetString(2);
        ...
        // GetUserFeedbackData Function
        public static List<UserFeedbackData> GetUserFeedbackData(string crn, string answer, string from_date, string to_date, int rating, int starting_index, int record_limit)
        {
            var dbManager = new DBManager("DBConnectionweb");

            OracleConnection connection = null;
            var parameters = new List<OracleParameter>();
            List<UserFeedbackData> ufd = new List<UserFeedbackData>();
            if (from_date == null && to_date == null || from_date == "" && to_date == "")
            {
                from_date = DateTime.Now.ToString("yyyy-MM-dd");
            ...
            parameters.Add(dbManager.CreateParameter("v_crn", crn, OracleDbType.Varchar2));
            parameters.Add(dbManager.CreateParameter("v_answer", answer, OracleDbType.Varchar2));
            parameters.Add(dbManager.CreateParameter("v_from_date", from_date + " 00:00:00", OracleDbType.Varchar2));
            parameters.Add(dbManager.CreateParameter("v_to_date", to_date + " 23:59:59", OracleDbType.Varchar2));
            parameters.Add(dbManager.CreateParameter("v_rating", rating, OracleDbType.Int64));
            parameters.Add(dbManager.CreateParameter("v_start_index", starting_index, OracleDbType.Int64));
            parameters.Add(dbManager.CreateParameter("v_record_limit", record_limit, OracleDbType.Int64));
            parameters.Add(dbManager.CreateParameter("data_cursor", OracleDbType.RefCursor, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("v_total_records", OracleDbType.Int32, ParameterDirection.Output));
            var dataReader = dbManager.GetDataReader("GET_USER_FEEDBACK_DATA", CommandType.StoredProcedure, parameters.ToArray(), out connection);
            while (dataReader.Read())
            {
                ufd.Add(new UserFeedbackData
                {
                    CRN = dataReader.IsDBNull(0) ? null : dataReader.GetString(0),
                    rating = dataReader.IsDBNull(1) ? 0 : dataReader.GetInt32(1),
                    user_answer1 = dataReader.IsDBNull(2) ? null : dataReader.GetString(2),
                    user_answer2 = dataReader.IsDBNull(3) ? null : dataReader.GetString(3),
                    suggestion = dataReader.IsDBNull(4) ? null : dataReader.GetString(4),
                    created_on = dataReader.IsDBNull(5) ? null : dataReader.GetString(5)
        ...
        //Fetching Master data for User Answer Data
        public List<MasterUserAnswerFetch> MasterUserAnswerFetch()
        {
            ...
            OracleConnection connection = null;
            var parameters = new List<OracleParameter>();
            List<MasterUserAnswerFetch> msd = new List<MasterUserAnswerFetch>();
            parameters.Add(dbManager.CreateParameter("answer_cursor", OracleDbType.RefCursor, ParameterDirection.Output));
            var dataReader = dbManager.GetDataReader("GET_USER_ANSWER_MASTER_DETAILS", CommandType.StoredProcedure, parameters.ToArray(), out connection);
            while (dataReader.Read())
            {
                msd.Add(new MasterUserAnswerFetch
                {
                    answer_id = dataReader.GetInt32(0),
                    user_answer = dataReader.GetString(1)
                });
            }
            dataReader.Close();
            dbManager.CloseConnection(connection);
        ...
        public UserFeedbackAnswerCount UserFeedbackAnswerCount()
        {
            ...
            parameters.Add(dbManager.CreateParameter("like_total_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("simplified_process_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("easy_to_follow_instructions_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("quick_login_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("face_correctly_identified_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("like_none_count", OracleDbType.Int64, ParameterDirection.Output));

            //What do you not like the most?
            parameters.Add(dbManager.CreateParameter("not_like_total_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("many_attempts_required_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("instructions_are_confusing_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("lengthy_process_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("camera_not_working_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("face_not_identified_correctly_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("application_crashed_count", OracleDbType.Int64, ParameterDirection.Output));
            parameters.Add(dbManager.CreateParameter("not_like_none_count", OracleDbType.Int64, ParameterDirection.Output));

            OracleCommand objCmd = dbManager.GetCommand("SP_USER_FEEDBACK_ANSWER_COUNT", CommandType.StoredProcedure, parameters.ToArray(), out connection);
            //connection.Open();
            //objCmd.ExecuteReader();
            connection.Open();
            dataReader = objCmd.ExecuteReader();
            dataReader.Close();
            dbManager.CloseConnection(connection);
            UserFeedbackAnswerCount ufac = new UserFeedbackAnswerCount();

            //What do you like the most?
            ufac.simplified_process_count = Convert.IsDBNull(objCmd.Parameters["simplified_process_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["simplified_process_count"].Value.ToString());
            ufac.easy_to_follow_instructions_count = Convert.IsDBNull(objCmd.Parameters["easy_to_follow_instructions_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["easy_to_follow_instructions_count"].Value.ToString());
            ufac.quick_login_count = Convert.IsDBNull(objCmd.Parameters["quick_login_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["quick_login_count"].Value.ToString());
            ufac.face_correctly_identified_count = Convert.IsDBNull(objCmd.Parameters["face_correctly_identified_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["face_correctly_identified_count"].Value.ToString());
            ufac.like_none_count = Convert.IsDBNull(objCmd.Parameters["like_none_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["like_none_count"].Value.ToString());

            //What do you not like the most?
            ufac.not_like_total_count = Convert.IsDBNull(objCmd.Parameters["not_like_total_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["not_like_total_count"].Value.ToString());
            ufac.many_attempts_required_count = Convert.IsDBNull(objCmd.Parameters["many_attempts_required_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["many_attempts_required_count"].Value.ToString());
            ufac.instructions_are_confusing_count = Convert.IsDBNull(objCmd.Parameters["instructions_are_confusing_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["instructions_are_confusing_count"].Value.ToString());
            ufac.lengthy_process_count = Convert.IsDBNull(objCmd.Parameters["lengthy_process_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["lengthy_process_count"].Value.ToString());
            ufac.camera_not_working_count = Convert.IsDBNull(objCmd.Parameters["camera_not_working_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["camera_not_working_count"].Value.ToString());
            ufac.face_not_identified_correctly_count = Convert.IsDBNull(objCmd.Parameters["face_not_identified_correctly_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["face_not_identified_correctly_count"].Value.ToString());
            ufac.application_crashed_count = Convert.IsDBNull(objCmd.Parameters["application_crashed_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["application_crashed_count"].Value.ToString());
            ufac.not_like_none_count = Convert.IsDBNull(objCmd.Parameters["not_like_none_count"].Value) ? 0 : Convert.ToInt32(objCmd.Parameters["not_like_none_count"].Value.ToString());
